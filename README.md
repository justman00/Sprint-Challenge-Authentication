...
1. What is the purpose of using _sessions_?
   the purpose of session is to not leave a foerever access to the user and restrict it in a timely manner
1. What does bcrypt do to help us store passwords in a secure manner.
   it hashes them with a specific salt(number) that is impossible to return back
1. What does bcrypt do to slow down attackers?
   It uses sync, which is based on iterations thus making it incredibly hard to hack
